...
function pushForm() {
  ...
  formData[12].addEventListener("change", newsletterData);
  locationData();
}
...
function locationData(e) {
  var valid = false;
  var i = 0
  console.log(locationCheckbox.length)
  console.log(locationCheckbox)
  console.log(locationCheckbox[0])
  console.log(locationCheckbox[0].checked)
  ...
  */
 while (i < locationCheckbox.length) {
  if (locationCheckbox[i].checked == true) {
    console.log("test")
    valid = true;
  }
  i++;
